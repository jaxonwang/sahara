...
from sahara import config as cfg
...
def get_fake_worker_instances():
    ...
    # node group is immutable, a work around
    return ng.instances
...
class TestPluginUtils(b.SaharaTestCase):
    ...
    def test_install_packages(self, install_packages):
        packages = mock.Mock()
    ...
    def test_start_cloudera_agents(self,
                                   configure_agent, start_agent):
        instances = get_fake_worker_instances()
    ...
    def test_put_hive_hdfs_xml(self):
    ...
    def test_create_hive_hive_directory(self):
        cluster = get_concrete_cluster()
