...
from sahara.plugins.cdh.v5_4_0.edp_engine import EdpOozieEngine
from sahara.plugins.cdh.v5_4_0.edp_engine import EdpSparkEngine
from sahara.plugins.cdh.v5_4_0 import versionhandler
from sahara.tests.unit import base


class VersionHandlerTestCase(base.SaharaTestCase):

    plugin_path = "sahara.plugins.cdh.v5_4_0."
    cloudera_utils_path = plugin_path + "cloudera_utils.ClouderaUtilsV540."
    plugin_utils_path = plugin_path + "plugin_utils.PluginUtilsV540."
