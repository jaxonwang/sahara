...
def get_fake_cluster_with_process(processes={},
                                  provided_ng_list=[], **kwargs):
    inst_counter = count_generator()
    ng_counter = count_generator()
    ng_id_counter = count_generator()
